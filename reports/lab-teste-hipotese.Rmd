...
# ENTENDER COMO PEGA O VALOR E O P-VALOR
```{r}
...
```{r}
mean(abs(diffs1) >= abs(theta_embaralhado(buscas_com_results_zero)))
```
...
theta_embaralhado(buscas_com_results_zero, 1:NROW(buscas))
```
